...
describe("Card test", () => {
    test("Finished card test", () => {
        const datavalue = render(<TestCard value={1} title="Test Card" author="Test author" numberOfReads="1.9k reads" timeToRead="13-minute read" isFinished={true} />)
    ...
    test("Read again card test", () => {
        const value = render(<TestCard value={1} title="Test Card" author="Test author" numberOfReads="1.9k reads" timeToRead="13-minute read" isFinished={false} readAgain={true} />)
    ...
    test("Add To Library card test", () => {
        const value = render(<TestCard value={1} title="Test Card" author="Test author" numberOfReads="1.9k reads" timeToRead="13-minute read" isFinished={false} addToLibrary={true} />)
